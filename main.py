...
async def start_command(message: types.Message):
    ...
    if admin_groups:
        ...
        intro_text = "🛡️ <b>مرحباًبك في بوت الحارس الأمني المتقدم!</b>\n\n  

🌟 المميزات الرئيسية:
✅ كشف ذكي للسبام: أرقام هاتفية، روابط مشبوهة، كلمات ممنوعة
✅ أنظمة حماية متعددة: كتم، حظر، تحذير، أو مزيج منها
✅ الوضع الليلي: إغلاق تلقائي للمجموعة في أوقات محددة
✅ حماية الأعضاء الجدد: مراقبة صارمة للأعضاء حديثي الانضمام
✅ حظر دول: منع أعضاء من دول محددة من الانضمام
✅ كلمات ممنوعة: نظام كشف متقدم للكلمات والعبارات المحظورة
✅ روابط ممنوعة: منع روابط مواقع محددة
✅ استثناء أعضاء: إعفاء أعضاء بناءً على مدة الانضمام
✅ إشعارات مخصصة: تخصيص مدة بقاء إشعارات العقوبات

⚙️ لوحة تحكم متقدمة:
📱 واجهة إدارة سهلة الاستخدام
🔧 إعدادات قابلة للتخصيص بالكامل
📊 إحصائيات مفصلة عن المخالفات
🔄 تحديث مباشر للإعدادات

🔒 ملاحظة مهمة:
البوت يعمل فقط في المجموعات المسجلة في النظام.
